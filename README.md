# EFI_T470P
#### T470P黑苹果EFI文件，10.14.5安装测试通过<br/>
...
- 更新各种驱动到最新版本<br/>
- 提供两种核显设置方案，如下：<br/>
- config-14,1,191b,1916.plist：默认方案，机型14,1，仿冒1916，存在HEVC硬解失败问题；<br/>
- config-14,1,591b,5916.plist：备选方案，机型14,1，设置5916，存在启动台和Safari的背景色带（颜色过渡不平滑）问题和水波纹花屏问题；<br/>
- 以上两种方案自行选择<br/>